...
class MetroAgi:
    def __init__(self):
        ...
        self.hat_renkleri = {"Kırmızı Hat": "red", "Mavi Hat": "blue", "Turuncu Hat": "orange"} # Define hat_renkleri as an instance variable using self.
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        kuyruk = deque([(baslangic, [baslangic])])  # (istasyon, şu ana kadarki yol)
        ziyaret_edildi = set()
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            ...
            if mevcut == hedef:
                return (yol, sure)  # Hedefe ulaştık
    ...
    def ag_ciz(self):
      G = nx.Graph()  # Yeni bir Graph nesnesi oluştur

      # İstasyonları ve hat bilgilerini ekleme
      for istasyon_id, istasyon in self.istasyonlar.items():
          G.add_node(istasyon_id, label=istasyon.ad, color=self.hat_renkleri.get(istasyon.hat, "gray"))  # Hat rengi yoksa gri kullanır
      ...
      # Düğümlerin renklerini belirleme
      node_colors = [G.nodes[n]["color"] for n in G.nodes]

      # Görselleştirme
      plt.figure(figsize=(10, 8))
      pos = nx.spring_layout(G, seed=42)  # Sabit bir düzen
